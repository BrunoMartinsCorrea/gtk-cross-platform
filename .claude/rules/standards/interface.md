...
- `inspect_container(id: &str) -> Result<String, ContainerError>`
...
3. Handle network timeouts and socket connection failures as `ContainerError::RuntimeNotAvailable`
...
When adding a new runtime: register it after order 4.
