...
- After running `/meta:knowledge-audit` — apply the gaps it found
...
Apply all documentation fixes identified by `/meta:knowledge-audit`. Read the files listed
...
Add `glib-compile-schemas` to Requirements table as a build-time dependency (
`part of libglib2.0-dev / glib2-devel / glib (Homebrew)`).
