...
# ops:store-submission

Invoke with `/ops:store-submission` after all artifacts are packaged and signed.

## When to use

- After `/ops:artifact-signing` confirms all artifacts are signed and verified
