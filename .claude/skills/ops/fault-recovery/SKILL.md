...
Invoke with `/ops:fault-recovery` when a release or distribution artifact has a critical defect.
...
A recovery action log: what was broken, what platform, what action was taken, and confirmation that the fixed artifact is live.
