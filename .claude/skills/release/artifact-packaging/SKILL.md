...
> **Release pipeline — Step 1 of 3:** `release:artifact-packaging` → `release:artifact-signing` →
`release:store-submission`

Invoke with `/release:artifact-packaging` when preparing a release build for distribution.
