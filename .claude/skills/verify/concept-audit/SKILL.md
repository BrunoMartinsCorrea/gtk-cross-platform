...
version: 1.0.0
description: Find internal conceptual inconsistencies: naming, layer leaks, trait contracts, threading
---

# verify:concept-audit
...
This audit differs from `/verify:compliance-audit` (documented vs implemented) and
`/verify:github-audit` (repository health). Its scope is: *does the code form a coherent,
