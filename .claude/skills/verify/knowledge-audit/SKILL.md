---
name: verify:knowledge-audit
version: 1.0.0
description: Audit documentation layer for staleness, cross-document inconsistencies, and coverage gaps
---

# verify:knowledge-audit
...
- `/verify:compliance-audit` — documented concepts vs. implementation (i18n, A11Y, threading, architecture)
- `/verify:concept-audit` — internal code inconsistencies
- `/verify:github-audit` — repository health (CI/CD, security, distribution)
