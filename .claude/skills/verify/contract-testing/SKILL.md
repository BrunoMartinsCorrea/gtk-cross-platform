...
Invoke with `/verify:contract-testing` when adding a new `IContainerDriver` method or verifying
...
All contract tests use `MockContainerDriver` (in-memory, no socket required). Location:
