...
Invoke with `/pipeline:work-planning` at the start of any non-trivial feature.
...
A task list suitable for `TaskCreate` entries, plus a one-paragraph summary of the feature scope, the main risk, and the estimated total effort.
